# OneSpread submission package

Prepared September 4, 2026 for the [Alpaca AI Trading Agents Hackathon](https://lablab.ai/ai-hackathons/alpaca-ai-trading-agents-hackathon).

## Ready to use

- Public source: https://github.com/Aldridgexia/onespread
- [Submission text](submission.md): copyable title, tagline, descriptions, and technology tags.
- [Pitch slides, PDF](OneSpread.pdf): six slides for upload.
...
- [Event page](https://lablab.ai/ai-hackathons/alpaca-ai-trading-agents-hackathon): event context and date range.
- [lablab participation guide](https://lablab.ai/guide): solo team registration and online prototype/video/deck expectations.
- [lablab AI hackathon guide](https://lablab.ai/guide/ai-hackathons): public repository, video, and pitch-deck preparation. Follow the actual event portal if its requirements differ.
